...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PC3     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = VIN_CHGPMP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
    HAL_GPIO_Init(VIN_CHGPMP_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM20_MspPostInit 0 */
    ...
    PB2     ------> TIM20_CH1
    */
    GPIO_InitStruct.Pin = VOUT_CHGPMP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM20;
    HAL_GPIO_Init(VOUT_CHGPMP_GPIO_Port, &GPIO_InitStruct);
