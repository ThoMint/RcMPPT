...
int main(void) {
	...
	while (LL_ADC_IsCalibrationOnGoing(ADC1) != 0)
		;
	HAL_Delay(1);	//Wait after calibration befor activation ADC
	LL_ADC_Enable(ADC1);
	...
	LL_HRTIM_EnableOutput(HRTIM1,
			LL_HRTIM_OUTPUT_TE1 | LL_HRTIM_OUTPUT_TE2 | LL_HRTIM_OUTPUT_TF1
					| LL_HRTIM_OUTPUT_TF1);
	//Enable Interrupts
...
void SystemClock_Config(void) {
	...
	PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_UART5
			| RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_USB
...
static void MX_HRTIM1_Init(void) {
	...
	NVIC_SetPriority(HRTIM1_TIMF_IRQn,
			NVIC_EncodePriority(NVIC_GetPriorityGrouping(), 0, 0));
  ...
  uint32_t Timeout = 100; /* Timeout Initialization */
	...
	LL_HRTIM_ConfigADCTrig(HRTIM1, LL_HRTIM_ADCTRIG_2,
	LL_HRTIM_ADCTRIG_UPDATE_TIMER_F, LL_HRTIM_ADCTRIG_SRC24_TIMFCMP3);
	LL_HRTIM_SetADCPostScaler(HRTIM1, LL_HRTIM_ADCTRIG_2, 0x0);
	LL_HRTIM_TIM_SetPrescaler(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_PRESCALERRATIO_MUL32);
	LL_HRTIM_TIM_SetCounterMode(HRTIM1, LL_HRTIM_TIMER_E,
	...
	LL_HRTIM_TIM_SetUpdateGating(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_UPDATEGATING_INDEPENDENT);
	LL_HRTIM_TIM_SetCountingMode(HRTIM1, LL_HRTIM_TIMER_E,
	...
	LL_HRTIM_TIM_SetInterleavedMode(HRTIM1, LL_HRTIM_TIMER_E,
	...
	LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_UPDATETRIG_NONE | LL_HRTIM_UPDATETRIG_REPETITION);
	LL_HRTIM_TIM_SetResetTrig(HRTIM1, LL_HRTIM_TIMER_E,
	...
	LL_HRTIM_TIM_SetBurstModeOption(HRTIM1, LL_HRTIM_TIMER_E,
	...
	LL_HRTIM_DT_SetPrescaler(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_DT_PRESCALER_MUL8);
	LL_HRTIM_DT_SetRisingValue(HRTIM1, LL_HRTIM_TIMER_E, 136);
	LL_HRTIM_DT_SetRisingSign(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_DT_RISING_POSITIVE);
	LL_HRTIM_DT_SetFallingValue(HRTIM1, LL_HRTIM_TIMER_E, 136);
	LL_HRTIM_DT_SetFallingSign(HRTIM1, LL_HRTIM_TIMER_E,
	LL_HRTIM_DT_FALLING_POSITIVE);
	LL_HRTIM_OUT_SetPolarity(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUT_POSITIVE_POLARITY);
	LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUTPUTSET_TIMCMP1);
	LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUTPUTRESET_TIMPER);
	LL_HRTIM_OUT_SetIdleMode(HRTIM1, LL_HRTIM_OUTPUT_TE1, LL_HRTIM_OUT_NO_IDLE);
	LL_HRTIM_OUT_SetIdleLevel(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUT_IDLELEVEL_INACTIVE);
	LL_HRTIM_OUT_SetFaultState(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUT_FAULTSTATE_NO_ACTION);
	LL_HRTIM_OUT_SetChopperMode(HRTIM1, LL_HRTIM_OUTPUT_TE1,
	LL_HRTIM_OUT_CHOPPERMODE_DISABLED);
	LL_HRTIM_OUT_SetPolarity(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUT_POSITIVE_POLARITY);
	LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUTPUTSET_NONE);
	LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUTPUTRESET_NONE);
	LL_HRTIM_OUT_SetIdleMode(HRTIM1, LL_HRTIM_OUTPUT_TE2, LL_HRTIM_OUT_NO_IDLE);
	LL_HRTIM_OUT_SetIdleLevel(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUT_IDLELEVEL_INACTIVE);
	LL_HRTIM_OUT_SetFaultState(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUT_FAULTSTATE_NO_ACTION);
	LL_HRTIM_OUT_SetChopperMode(HRTIM1, LL_HRTIM_OUTPUT_TE2,
	LL_HRTIM_OUT_CHOPPERMODE_DISABLED);
  ...
  uint32_t Timeout = 100; /* Timeout Initialization */
	...
	LL_HRTIM_TIM_SetPrescaler(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_PRESCALERRATIO_MUL32);
	LL_HRTIM_TIM_SetCounterMode(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_MODE_CONTINUOUS);
	LL_HRTIM_TIM_SetPeriod(HRTIM1, LL_HRTIM_TIMER_F, PWM_PERIOD);
	LL_HRTIM_TIM_SetRepetition(HRTIM1, LL_HRTIM_TIMER_F, 0x00);
	LL_HRTIM_TIM_SetUpdateGating(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_UPDATEGATING_INDEPENDENT);
	LL_HRTIM_TIM_SetCountingMode(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_COUNTING_MODE_UP);
	...
	LL_HRTIM_TIM_SetInterleavedMode(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_INTERLEAVED_MODE_DISABLED);
	...
	LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_UPDATETRIG_NONE | LL_HRTIM_UPDATETRIG_REPETITION);
	LL_HRTIM_TIM_SetResetTrig(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_RESETTRIG_NONE);
	...
	LL_HRTIM_TIM_SetBurstModeOption(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_BURSTMODE_MAINTAINCLOCK);
	...
	LL_HRTIM_DT_SetPrescaler(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_DT_PRESCALER_MUL8);
	LL_HRTIM_DT_SetRisingValue(HRTIM1, LL_HRTIM_TIMER_F, 136);
	LL_HRTIM_DT_SetRisingSign(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_DT_RISING_POSITIVE);
	LL_HRTIM_DT_SetFallingValue(HRTIM1, LL_HRTIM_TIMER_F, 136);
	LL_HRTIM_DT_SetFallingSign(HRTIM1, LL_HRTIM_TIMER_F,
	LL_HRTIM_DT_FALLING_POSITIVE);
	LL_HRTIM_OUT_SetPolarity(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUT_POSITIVE_POLARITY);
	LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUTPUTSET_TIMPER);
	LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUTPUTRESET_TIMCMP1);
	LL_HRTIM_OUT_SetIdleMode(HRTIM1, LL_HRTIM_OUTPUT_TF1, LL_HRTIM_OUT_NO_IDLE);
	LL_HRTIM_OUT_SetIdleLevel(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUT_IDLELEVEL_INACTIVE);
	LL_HRTIM_OUT_SetFaultState(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUT_FAULTSTATE_NO_ACTION);
	LL_HRTIM_OUT_SetChopperMode(HRTIM1, LL_HRTIM_OUTPUT_TF1,
	LL_HRTIM_OUT_CHOPPERMODE_DISABLED);
	LL_HRTIM_OUT_SetPolarity(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUT_POSITIVE_POLARITY);
	LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUTPUTSET_NONE);
	LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUTPUTRESET_NONE);
	LL_HRTIM_OUT_SetIdleMode(HRTIM1, LL_HRTIM_OUTPUT_TF2, LL_HRTIM_OUT_NO_IDLE);
	LL_HRTIM_OUT_SetIdleLevel(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUT_IDLELEVEL_INACTIVE);
	LL_HRTIM_OUT_SetFaultState(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUT_FAULTSTATE_NO_ACTION);
	LL_HRTIM_OUT_SetChopperMode(HRTIM1, LL_HRTIM_OUTPUT_TF2,
	LL_HRTIM_OUT_CHOPPERMODE_DISABLED);
...
static void MX_GPIO_Init(void) {
	...
	GPIO_PIN_2 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_14 | GPIO_PIN_9,
			GPIO_PIN_RESET);
